...
def local_explainability():
    ...
    explain_utils.show_local_explainability(
        st.session_state["explainer"], st.session_state["explanation"],
...
def show_explainability():
    ...
    explain_utils.show_shap_bar_plot(
        st.session_state["explanation"], st.session_state["unique_targets"]
    )

    # Feature Importance Using Beeswarm Plot
    st.subheader("Feature Importance using Beeswarm Plot")
    explain_utils.show_shap_beeswarm_plot(
        st.session_state["explanation"], st.session_state["unique_targets"]
    )
    ...
    explain_utils.extract_easy_difficult_samples(
        config, oof_df, st.session_state["tree_model"], st.session_state["fold_modelx"]
    )
